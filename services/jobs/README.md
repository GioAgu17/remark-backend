...
This is the jobs section of the Remark application. From here, multiple triggers or tasks are being shceduled to perform on Remark DB and for the application. The serverless frameworks offers an optimal way of scheduling and triggering tasks at a minimal cost. For more information on `schedule` event check out the Serverless docs on [schedule](https://serverless.com/framework/docs/providers/aws/events/schedule/).

We schedule events with the Rate syntax
